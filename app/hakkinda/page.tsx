...
import { getAboutPageContent, getSiteSettings } from "@/app/content-actions";
...
export default async function HakkindaPage() {
    ...
    const stats = aboutContent.stats.length > 0 ? aboutContent.stats : [
    ...
    const values = aboutContent.values.length > 0 ? aboutContent.values : [
    ...
    const team = aboutContent.team.length > 0 ? aboutContent.team : [
                ...
                <div className="container px-4 mx-auto max-w-5xl relative z-10">
                    ...
                    <div className="prose prose-invert prose-lg max-w-none mb-16">
                        <div className="bg-slate-900/50 border border-white/10 rounded-2xl p-8 md:p-10 backdrop-blur-sm">
                            <h2 className="text-2xl font-bold text-emerald-400 mb-6">{story.title}</h2>
                            {story.paragraphs && story.paragraphs.map((paragraph: string, index: number) => (
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                        {stats.map((stat: any, index: number) => {
                            ...
                            return (
                                <div key={index} className="text-center p-6 bg-slate-900/50 border border-white/10 rounded-2xl backdrop-blur-sm">
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {values.map((value: any, index: number) => {
                                ...
                                return (
                                    <div key={index} className="bg-slate-900/50 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                    ...
                    <div className="mb-16">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                            {team.map((member: any, index: number) => (
                                <div key={index} className="bg-slate-900/50 border border-white/10 rounded-xl p-5 backdrop-blur-sm">
                    ...
                    <div className="text-center bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border border-emerald-500/30 rounded-2xl p-10">
                        ...
                        <p className="text-slate-300 mb-6">{formattedDate}&apos;da Yalova&apos;da buluşalım!</p>
                        <Link href="/basvuru">
