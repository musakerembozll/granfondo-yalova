            ...
            >
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8">
                    ...
                    <Button
                        ...
                        variant="outline"
                        disabled={true}
                        className="w-full h-12 border-slate-700 bg-slate-800/50 text-slate-500 cursor-not-allowed mb-6 relative"
                    >
                        <svg className="h-5 w-5 mr-3 opacity-50" viewBox="0 0 24 24">
                        ...
                        Google ile Kayıt Ol
                        <span className="absolute right-3 text-xs bg-slate-700 text-slate-300 px-2 py-0.5 rounded">Yakında</span>
                    </Button>
